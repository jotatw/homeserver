...
| 2 | **Navegação por role** — como o App monta as telas | `navigation.md` | pendente |
| 3 | **Meu espaço** — dashboard (status + atalhos) | `dashboard.md` | pendente |
...
- [ ] Fluxos 2-8 (montar um por vez, validando com o usuário)
