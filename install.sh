...
_configure_firewall() {
    ...
    ufw allow proto tcp from 192.168.1.0/24 to any port 3000  # homepage
    ufw allow proto tcp from 192.168.1.0/24 to any port 3001  # gitea http
    ufw allow proto tcp from 192.168.1.0/24 to any port 2222  # gitea ssh
    ufw allow proto tcp from 192.168.1.0/24 to any port 8000  # api
    ufw allow proto tcp from 192.168.1.0/24 to any port 8080  # filebrowser
    ufw allow proto tcp from 192.168.1.0/24 to any port 139   # samba
    ufw allow proto tcp from 192.168.1.0/24 to any port 445   # samba
    ufw allow proto udp from 192.168.1.0/24 to any port 137:138  # samba
...
main() {
    ...
    info "Dashboard: http://192.168.1.10:3000"
}
